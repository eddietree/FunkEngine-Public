...
struct gmCodeTreeNode
{
  ...
  /// \return a tree node
  static gmCodeTreeNode * Create(gmCodeTreeNodeType a_type, int a_subType, int a_lineNumber, intptr_t a_subTypeType = 0);
