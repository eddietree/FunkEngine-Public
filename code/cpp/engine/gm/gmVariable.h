...
struct gmVariable
{
  ...
  explicit inline gmVariable(funk::v2 a_val) : m_type(GM_V2) { m_value.m_v2 = a_val.gmv2; }
  explicit inline gmVariable(funk::v2i a_val) : m_type(GM_V2I) { m_value.m_v2i = a_val.gmv2i; }
  explicit inline gmVariable(funk::v3 a_val) : m_type(GM_V3) { m_value.m_v3 = a_val.gmv3; }
  ...
  inline void SetV2(funk::v2 a_val) { m_type = GM_V2; m_value.m_v2 = a_val.gmv2; }
  inline void SetV2i(funk::v2i a_val) { m_type = GM_V2I; m_value.m_v2i = a_val.gmv2i; }
  inline void SetV3(funk::v3 a_val) { m_type = GM_V3; m_value.m_v3 = a_val.gmv3; }
  ...
  inline bool IsReference() const { return m_type > GM_V3; }
  ...
  inline bool IsV2() const { return m_type == GM_V2; }
  inline bool IsV2i() const { return m_type == GM_V2I; }
  inline bool IsV3() const { return m_type == GM_V3; }
  ...
  inline gmType GetType() const { return m_type; }
  inline int GetInt() const  { return m_value.m_int; }
  inline float GetFloat() const { return m_value.m_float; }
  inline funk::v2 GetV2() const { return m_value.m_v2; }
  inline funk::v2i GetV2i() const { return m_value.m_v2i; }
  inline funk::v3 GetV3() const { return m_value.m_v3; }
