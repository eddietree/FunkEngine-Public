...
#define GM_PRINTF             TRACE // FunkEngine
...
typedef float gmfloat;
  ...
  typedef __int64_t gmptr; // machine pointer size as int
  typedef __uint64_t gmuptr; // machine pointer size as int
  typedef __int64_t gmint64;
  typedef __uint64_t gmuint64;
#else //!GM_PTR_SIZE_64
